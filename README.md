...
> [!NOTE]
> 
> 原懒人配置文件及关键词列表的作者因故更名并撤销所有更新，为继续改进相关文件且使用户平滑过渡，本仓库将基于其文件的最终版本进行后续基本维护。[Johnshall 仓库](https://github.com/Johnshall/Shadowrocket-ADBlock-Rules-Forever) 提供的版本也将以本仓文件为基础继续更新。本仓以普通用户的身份对原作者及 [Johnshall](https://github.com/Johnshall) 等所有对相关项目做出贡献的人表示由衷的感谢！
